...
using solution1.Models.ModelApp.Connection;
using System;
...
namespace solution1.Models.Business.Connection
{
    public class objDatabaseContainer : db_ManageEntities
    {
        public objDatabaseContainer(string connectString = null) { }
    }
    public class ConnectionBC
    {
        private string dbContainer = "db_ManageEntities";
